...
@MappedSuperclass
public class ScheduleMapped extends AbstractApprovalEntity {
  // method for ArrowEntity
  @Override
  public Class<? extends arrow.mems.persistence.entity.Schedule> getEntityClass() {
    return arrow.mems.persistence.entity.Schedule.class;
  }
  
  //default constructor
  public ScheduleMapped() {
  }
  
  @Column(name="SCHED_BASE_ID")
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "schedule_seq_gen")
  @SequenceGenerator(name = "schedule_seq_gen", sequenceName = "schedule_sched_base_id_seq", allocationSize=1)
  protected int schedBaseId;
  ...
  protected java.lang.Integer intervalMonth;

  public java.lang.Integer getIntervalMonth() {
    return this.intervalMonth;
  }

  public void setIntervalMonth(java.lang.Integer intervalMonth) {
