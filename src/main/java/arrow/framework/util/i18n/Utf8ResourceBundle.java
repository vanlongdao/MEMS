 ...
 *
 * Utility that allows having multi-byte characters inside java .property files. It removes the need
 * for Sun's native2ascii application, you can simply have UTF-8 encoded editable .property files.
 *
