...
public class Assert {
  ...
  public static void hasLength(String text, String message) {
    if (!ArrowStrUtils.hasLength(text))
      throw new IllegalArgumentException(message);
  }
  ...
  public static void doesNotContain(String textToSearch, String substring, String message) {
    if (ArrowStrUtils.hasLength(textToSearch) && ArrowStrUtils.hasLength(substring) && textToSearch.contains(substring))
      throw new IllegalArgumentException(message);
  }
  ...
  public static void isInstanceOf(Class<?> type, Object obj, String message) {
    ...
    if (!type.isInstance(obj))
      throw new IllegalArgumentException((ArrowStrUtils.hasLength(message) ? message + " " : "") + "Object of class [" + (obj != null ? obj
   ...
   * {@code false}. Call isTrue if you wish to
