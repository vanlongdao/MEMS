...
(function($){
  ...
  $.declare('scribble',{
    ...
    _applyClasses : function(){
      ...
      this.el[0].width = 300; parseInt(computedStyle.width,10);
      this.el[0].height = 150; parseInt(computedStyle.height,10);
      this.shadowCanvas[0].width = 300; parseInt(computedStyle.width,10);
      this.shadowCanvas[0].height = 150; parseInt(computedStyle.height,10);
    },
    ...
    _getXY : function(e){
      ...
      x = e.clientX || e.layerX || touchEvent.pageX;
      y = e.clientY || e.layerY || touchEvent.pageY;
